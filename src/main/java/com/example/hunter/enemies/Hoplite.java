...
public class Hoplite extends Enemy {
    ...
    public Hoplite(double x, double y, double speed, int initialHealth, double gameWidth, double gameHeight) {
        super(x, y, speed, initialHealth);

        // load the sprite sheet
        Image spriteSheet = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/hoplite.png")));
        ...
        // match the sprite sheet with the object
