/*
This is the Peasant class, it is a subclass of the Enemy abstract superclass.
The Peasant appears in the Medieval Age.
*/
...
public class Peasant extends Enemy {
    ...
    public Peasant(double x, double y, double speed, int initialHealth) {
        super(x, y, speed, initialHealth);

        Image spriteSheet = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/Peasant.png")));
